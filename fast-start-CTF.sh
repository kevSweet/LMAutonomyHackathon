...
sleep 5
lxterminal --command="bash -i -c 'source ~/python2_env/bin/activate && python /home/hackathon-user/Desktop/LMAutonomyHackathon/sphere_games/host/fast_sim_tracker.py'"
sleep 1
